...
from rf4s.controller.input_state import InputStateManager
...
class Player:
    ...
    def __init__(self, cfg, timer: Timer, detection: Detection, result: BotResult):
        ...
        """
        self.cfg = cfg
        self.input_state = InputStateManager(logger)
        self.timer = timer
    ...
    def release_left_mouse_button(self):
        if self.cfg.BOT.CLICK_LOCK:
            ...
            self.input_state.release_mouse()
        self.mouse_pressed = False

    def hold_down_shift_key(self):
        self.input_state.hold_shift()
        self.shift_pressed = True

    def release_shift_key(self):
        self.input_state.release_shift()
        self.shift_pressed = False
    ...
    def start_waky_drifting_mode(self) -> None:
        """Custom Waky Drifting Mode."""
        ...
        while True:
            with self.loop_restart_handler():
                ...
                logger.info("WAKY DRIFTING MODE AKTIF")
                ...
                while drift_time < 35:
                    ...
                    logger.info(f"Drifting... {drift_time}m")

                    # Fish hooked detection
                    if self.detection.is_fish_hooked():

                        logger.warning("IKAN MENYAMBAR!")
                    ...
                    logger.info("Tidak ada ikan, reset drifting")
    ...
    def pull_fish(self, save: bool = True) -> None:
        ...
        logger.warning("FORCE HOLD MOUSE FOR PULL")
